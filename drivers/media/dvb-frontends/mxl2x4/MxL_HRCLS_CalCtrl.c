...
//  C = MXL_DIV_ROUND(C, 10);
  ...
  if (A)
  {
	...
	d3_term = A * D - MXL_DIV_ROUND_S((C * B), 10000);
	d3_divisor = A * (A * C - MXL_DIV_ROUND_S((B * B), 10000));
	D3 = E - MXL_DIV_ROUND_S(MXL_DIV_ROUND_S((C * C), 10000), A) -
	     div64_s64(d3_term * d3_term, d3_divisor);
